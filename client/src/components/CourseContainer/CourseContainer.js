...
function CourseContainer(props) {
    ...
    useEffect(() => {
        app.get("/trainee/my-courses/" + props.course.id + "/get-my-reviews", {
                    ...
                    >
                        <div style={{ display: "inline" }}>
                            <iframe
                                ...
                                key={props.course.preview_video?.replace(
                                    "watch?v=",
                                    "embed/"
                                )}
                                title="course-video"
                                src={props.course.preview_video?.replace(
                                    "watch?v=",
                                    "embed/"
                                )}
                                frameBorder="0"
                        ...
                        <div>
                            ...
                            {localStorage.getItem("type") !== "corporate" &&
                                props.owned !== true && (
                                    <div className="attribute">
                                        Price:{" "}
                                        {props.promotion &&
                                        new Date(props.promotion.deadline) >
                                            new Date() ? (
                                            <>
                            ...
                            {props.owned && location.state.displayAddReview && (
                                <>
                                    ...
                                    <div className="attribute">
                                        Progress:{" "}
                                        {getProgress(traineeCourse?.progress) *
                                            100}
                                        %
                                    </div>
                                </>
