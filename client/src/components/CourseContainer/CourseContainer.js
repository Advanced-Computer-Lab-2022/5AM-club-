...
function CourseContainer(props) {
        ...
        app.get(
            ...
            setRequested(
                res.data.pending.some(
                    (trainee) =>
                        trainee.username === localStorage.getItem("username")
                )
            );
        });
    ...
    useEffect(() => {
        ...
        if (
            ...
            app.get(
                "/trainee/my-courses/" + course.id + "/get-my-reviews"
            ).then((res) => {
                setMyReviews(res.data);
                app.get("/trainee/get-trainee-course", {
                    headers: {
                        courseId: course.id,
                ...
                >
                    ...
                    >
                        <iframe
                            ...
                            key={course.preview_video?.replace(
                                "watch?v=",
                                "embed/"
                            )}
                            title="course-video"
                            src={course.preview_video?.replace(
                                "watch?v=",
                                "embed/"
                            )}
                            allowFullScreen
                                ...
                                {localStorage.getItem("type") !== "corporate" &&
                                    props.owned !== true && (
                                        ...
                                        >
                                            Price:{" "}
                                            {props.promotion &&
                                            new Date(props.promotion.endDate) >
                                                new Date() &&
                                            new Date(
